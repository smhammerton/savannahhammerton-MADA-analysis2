...
Figure \@ref(fig:resultfigure1) shows COVID-19 deaths according to age group. 

```{r resultfigure1,  fig.cap='COVID-19 Deaths by Age Group', echo=FALSE}
knitr::include_graphics("../../results/resultfigure1.png")
```


Figure \@ref(fig:resultfigure2) shows COVID-19 deaths according to sex. 
```{r resultfigure2,  fig.cap='COVID-19 Deaths by Sex', echo=FALSE}
